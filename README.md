...
Blitter & Raw Image (issu du site neHe).
...
Voici un résumé succinct des possibilités d'utiliser cette application :

## OpenGL Tutorial #29.

Project Name: Jeff Molofee's OpenGL Tutorial

Project Description : Blitter & Raw Image Loading Tutorial

Authors Name: Andreas Löffler, Rob Fletcher & Jeff Molofee (aka NeHe)
